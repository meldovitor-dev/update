...
const choiceAProblem = {
    ...
    descricao:
        'Volte pro início e selecione o reparo relacionado ao seu problema na home do app.',
    botoes: [homeButton],
};
...
export const NON_DEFAULT_PAGES = {
    ...
    FALHA_MASSIVA_LENTIDAO_VOIP_COM_PREVISAO_GENERICA_REPETIDA:
        fibraFalhaMassivaTv,
    FALHA_MASSIVA_LENTIDAO_VOIP_COM_PREVISAO_GENERICA_REAPRAZADA:
        fibraFalhaMassivaTv,
    FALHA_MASSIVA_LENTIDAO_VOIP_COM_PREVISAO_DE_LENTIDAO: fibraFalhaMassivaTv,
    FALHA_MASSIVA_LENTIDAO_VOIP_COM_PREVISAO_DE_LENTIDAO_REPETIDA:
        fibraFalhaMassivaTv,
    FALHA_MASSIVA_LENTIDAO_VOIP_COM_PREVISAO_DE_LENTIDAO_REAPRAZADA:
        fibraFalhaMassivaTv,
    ...
    FALHA_MASSIVA_LENTIDAO_INTERNET_GENERICO_INTERNET_LENTA_REPETIDA:
        fibraFalhaMassiva,
    FALHA_MASSIVA_LENTIDAO_INTERNET_GENERICO_INTERNET_LENTA_REAPRAZADA:
        fibraFalhaMassiva,
